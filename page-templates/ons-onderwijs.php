 ...
 <main>
    ...
    <!-- END --- background swoosh -->
        <section class="py-4 md:py-10">
            <div class="container pb-4 md:pb-10">
                    <h2 class="text-red text-30 leading-36 md:leading-82 md:text-68 text-center w-full md:mb-1 mb-2 ">Ons team</h2>
                    <p class="text-center text-blue text-11 leading-14 md:text-18 md:leading-28 w-full max-w-[380px] md:max-w-[930px] mx-auto font-normal">
                        Leerlingen leren omgaan met de begeleiding van onze medewerkers.
                    </p>
            </div>
            <div class="container grid grid-cols-2 md:grid-cols-3 gap-2 lg:gap-6 max-w-[284px] md:max-w-[1118px]">
                <div class="col-span-1 relative overflow-hidden rounded-[10px] md:rounded-[15px]">
                    <img src="/wp-content/themes/obs-wereldwijs/img/local/person.jpg" class="w-full object-cover h-[161px] md:h-[326px] xl:h-[426px]" alt="">
                    <div class="background-image-blue w-full h-[65px] md:h-[173px] absolute bottom-0 right-0 left-0"></div>
                    <p class="max-w-[70px] text-center text-white absolute bottom-2 -translate-x-1/2 left-1/2 text-11 leading-14  md:text-20 md:leading-26">Naam Functie Groep</p>
                </div>
                <div class="col-span-1 relative overflow-hidden rounded-[10px] md:rounded-[15px]">
                    <img src="/wp-content/themes/obs-wereldwijs/img/local/person.jpg" class="w-full object-cover h-[161px] md:h-[326px] xl:h-[426px]" alt="">
                    <div class="background-image-blue w-full h-[65px] md:h-[173px] absolute bottom-0 right-0 left-0"></div>
